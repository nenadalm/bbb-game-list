...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$tr,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$td,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [app.views.thumbnail,data], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$td,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [app.views.title,data], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$td,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [app.views.min_players,data], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$td,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [app.views.max_players,data], null)], null)], null);
});
app.views.sortable_th = (function app$views$sortable_th(p__13479){
...
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13480__$1,cljs.core.cst$kw$text);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13480__$1,cljs.core.cst$kw$key);
var sorting = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13480__$1,cljs.core.cst$kw$sorting);
...
var next_dir = ((current_key_sorted)?(function (){var G__13483 = cljs.core.cst$kw$app_SLASH_sort_DASH_dir.cljs$core$IFn$_invoke$arity$1(sorting);
var fexpr__13482 = new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$asc,cljs.core.cst$kw$desc,cljs.core.cst$kw$desc,cljs.core.cst$kw$asc,cljs.core.cst$kw$cljs$analyzer_SLASH_analyzed,true], null);
return (fexpr__13482.cljs$core$IFn$_invoke$arity$1 ? fexpr__13482.cljs$core$IFn$_invoke$arity$1(G__13483) : fexpr__13482.call(null,G__13483));
...
return iter__4582__auto__(cljs.core.deref((function (){var G__13490 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$app$subs_SLASH_game_DASH_list], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__13490) : re_frame.core.subscribe.call(null,G__13490));
})()));
})()], null)], null);
});
